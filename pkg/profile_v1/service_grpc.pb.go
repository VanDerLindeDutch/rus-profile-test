...
const (
	Profiler_Find_FullMethodName = "/profile_v1.Profiler/find"
)
...
func (c *profilerClient) Find(ctx context.Context, in *FindRequest, opts ...grpc.CallOption) (*FindResponse, error) {
	out := new(FindResponse)
	err := c.cc.Invoke(ctx, Profiler_Find_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProfilerServer) Find(context.Context, *FindRequest) (*FindResponse, error) {
...
func _Profiler_Find_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfilerServer).Find(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Profiler_Find_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfilerServer).Find(ctx, req.(*FindRequest))
	}
...
var Profiler_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "profile_v1.Profiler",
	HandlerType: (*ProfilerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "find",
			Handler:    _Profiler_Find_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/profile_v1/service.proto",
}
